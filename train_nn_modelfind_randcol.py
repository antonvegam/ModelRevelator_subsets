...
with open('rename_randcol.yml', 'r') as file:
...
model = ResnetBuilder.build_resnet_18((16, 100, 100), 12)
#model = tf.keras.models.load_model(log_dir + '/weights.1754-2.11_0.6567_1000pos.hdf5')
