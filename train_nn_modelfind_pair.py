...
with open('rename_pair.yml', 'r') as file:
...
model = ResnetBuilder.build_resnet_18((26, 200, 200), 12)
#model = tf.keras.models.load_model(log_dir + '/weights.3382-1.84_0.7284_1000pos.hdf5')
