...
with open('rename_col.yml', 'r') as file:
...
model = ResnetBuilder.build_resnet_18((16, 200, 200), 12)
#model = tf.keras.models.load_model(log_dir + '/weights.07-4.49_0.3183_1000pos.hdf5')
